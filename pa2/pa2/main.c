...
{
    int opcode = instr >> 26;
    int funct = instr & 0b00000000000000000000000000111111;
    int rd = (instr >> 11) & 0b000000000000000011111;
    int rt = (instr >> 16) & 0b0000000000011111;
    int rs = (instr >> 21) & 0b00000011111;
    int shamt = (instr >> 6) & 0b00000000000000000000011111;
    int imm = instr & 0b00000000000000001111111111111111;
    int address = instr & 0b00000011111111111111111111;
    int sign = (instr >> 31);
    ...
    if(opcode == 0)
    {
        ...
        else if(funct == 0x03)//sra ***
        {
            ...
            {
                registers[rd] = (registers[rt] >> shamt) || (INT_MAX << (32 - shamt));
            }
            return 1;
        }
    ...
    else if(opcode != 0)
    {
        ...
        else if(opcode == 0x04)//beq
        {
            ...
            {
                pc = pc + 4 + (imm << 2); //target address = pc + offset*4
            }
            return 1;
        }
